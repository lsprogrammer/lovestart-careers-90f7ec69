...
const EmployerLogin = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Employer login submitted', { email, rememberMe });
  };
        ...
        <div className="w-full max-w-4xl bg-background rounded-2xl shadow-xl overflow-hidden grid md:grid-cols-2">
          ...
          <div className="hidden md:block relative">
            ...
            <div className="relative z-10 flex flex-col justify-end h-full p-8 text-white">
              <h2 className="text-2xl font-bold mb-2">Hire Top Talent</h2>
              <p className="text-white/80 text-sm leading-relaxed">
                Sign in to manage your job postings, review applications, and find the perfect candidates.
              </p>
            </div>
          </div>
          ...
          <div className="p-8 sm:p-10 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor="emp-remember" className="text-sm text-muted-foreground cursor-pointer">
                    Remember me
                  </label>
                </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" className="h-11 gap-2 text-sm">
